...
class Generator(object):
	...
	self.tp_properties = tp_properties
...
options:
    ...
    --no-properties
        Do not use tp-glib dbus properties
...
if __name__ == '__main__':
    ...
    Generator(dom, prefix, basename, signal_marshal_prefix, headers,
              end_headers, not_implemented_func, allow_havoc, tp_properties)()
